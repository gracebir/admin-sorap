    ...
    return (
        <main className='flex flex-col gap-6 lg:gap-8'>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8'>
                ...
                <StatCard count={7500} rate={-0.54} title='Visits' />
                <StatCard count={6500} rate={0.54} title='News Users' />
                <StatCard count={3500} rate={-0.54} title='Active Users' />
            </div>
            <div className='grid lg:grid-cols-4 grid-cols-1 md:gap-8 gap-6'>
                <DashboardChart />
