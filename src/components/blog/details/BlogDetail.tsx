    ...
    <div className="flex flex-col gap-8">
      <div className="flex justify-between items-center">
        ...
        >
          ...
          <span className="text-sm font-semibold">Retour au blogs</span>
        </Link>
        ...
        >
          ...
          <span className="text-sm font-semibold">Modifier le Blog</span>
        </Link>
      </div>
      ...
      <div>
        <h2 className="text-xl font-bold md:text-2xl ">{data?.data.title}</h2>
        {data?.data.content && (
          <ReactMarkdown
