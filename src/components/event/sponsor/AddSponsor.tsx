...
const AddSponsor: React.FC<{
  ...
  const [addSponsor, { isLoading, isError, error: errorSponsor }] =
      ...
      <div className="flex flex-col gap-5">
        ...
        <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end mt-2">
            <DefaultButton isLoading={isLoading} type="submit" text="Ajouter" />
          </div>
          {isError && (
            //@ts-expect-error this error is due the data structure
            <ErrorMessage text={errorSponsor?.data?.error_message} />
          )}
        </form>
      </div>
    </Modal>
