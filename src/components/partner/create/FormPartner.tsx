...
import { useAddPartnerMutation } from "@/lib/features/slice/partner/parterSlice";
import { partnerSchema } from "@/utils/validations/partnerSchema";
...
const FormPartner = () => {
    ...
    const [createPartner, { isLoading, error, isError }] =
    ...
    return (
        <div className='flex flex-col gap-6 md:gap-8'>
            <PageTitle text="Enregistrement d'un Partnaire" />
            <form
